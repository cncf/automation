...
# - a file named CouponsPreviousYears.csv should contains coupons to be used
...
coupons_data = pd.read_csv("CouponsPreviousYears.csv")
...
for lineToBeInserted in range(firstLineToBeInserted, lastLineToBeInserted+1, 1):
    ...
    with open('Kubestronaut-previousyears.tsv') as csv_file:
        lineCount = 1
...
coupons_data.to_csv("CouponsPreviousYears.csv")
