...
| <a name="requirement_oci"></a> [oci](#requirement\_oci) | 8.14.0 |
...
| Name | Type |
|------|------|
| [oci_containerengine_addon.cluster_autoscaler](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/containerengine_addon) | resource |
| [oci_containerengine_cluster.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/containerengine_cluster) | resource |
| [oci_containerengine_node_pool.service_worker](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/containerengine_node_pool) | resource |
| [oci_core_internet_gateway.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_internet_gateway) | resource |
| [oci_core_nat_gateway.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_nat_gateway) | resource |
| [oci_core_public_ip.ingress_ip](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_public_ip) | resource |
| [oci_core_public_ip.kcp_lb_ip](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_public_ip) | resource |
| [oci_core_route_table.private](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_route_table) | resource |
| [oci_core_route_table.public](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_route_table) | resource |
| [oci_core_security_list.k8s_api_endpoint](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_security_list) | resource |
| [oci_core_security_list.node](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_security_list) | resource |
| [oci_core_security_list.svc_lb](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_security_list) | resource |
| [oci_core_service_gateway.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_service_gateway) | resource |
| [oci_core_subnet.k8s_api_endpoint](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_subnet) | resource |
| [oci_core_subnet.node](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_subnet) | resource |
| [oci_core_subnet.svc_lb](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_subnet) | resource |
| [oci_core_vcn.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/resources/core_vcn) | resource |
| [oci_containerengine_cluster_kube_config.service](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/data-sources/containerengine_cluster_kube_config) | data source |
| [oci_containerengine_node_pool_option.amd64](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/data-sources/containerengine_node_pool_option) | data source |
| [oci_core_services.services](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/data-sources/core_services) | data source |
| [oci_identity_availability_domains.availability_domains](https://registry.terraform.io/providers/oracle/oci/8.14.0/docs/data-sources/identity_availability_domains) | data source |
...
| <a name="input_control_plane_k8s_version"></a> [control\_plane\_k8s\_version](#input\_control\_plane\_k8s\_version) | Kubernetes version for the control plane | `string` | n/a | yes |
| <a name="input_deploy_ingress"></a> [deploy\_ingress](#input\_deploy\_ingress) | Deploy Ingress IP address | `bool` | `false` | no |
...
| <a name="input_nodepool_k8s_version"></a> [nodepool\_k8s\_version](#input\_nodepool\_k8s\_version) | Kubernetes version for OKE node pools | `string` | n/a | yes |
...
| <a name="input_regional_service_cidr_label"></a> [regional\_service\_cidr\_label](#input\_regional\_service\_cidr\_label) | The Service CIDR Labels follow a specific naming convention based on the regional key of the location | `string` | n/a | yes |
